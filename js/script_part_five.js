monogatari.script({
    ...
    'PartFive': [
        ...
        //"show character  with fadeIn",
        "play voice 109",
        "roy Iya sih rif, enakan naik kereta juga ya kalo dipikir pikir.",
        "arif Iya makanya.",
        //"show character  with fadeIn",
        "play voice 110",
        ...
        "show character nadia bebasSenyum with fadeIn",
        "play voice 111",
        "nadia Dah siap, Saatnya berangkat.",
        "show character nadia bebasBicara with fadeIn",
        "play voice 112",
        ...
        //"show character  with fadeIn",
        "play voice 116",
        "nadia Kok ngga keliatan.",
        //Karena terlibat macet. Aku dan Roy pun datang terlambat.)
        "......",
        "arif Maaf Nad telat, tadi kami kena macet di jalan Dipenegoro.",
        "show character nadia bebasNormal at right with move transition 1s",
        "show character roy bicara at left with fadeIn right",
        "play voice 117",
        "roy Iya nih. Lama bet soalnya.",
        "show character nadia bebasMarah at right with fadeIn",
        "play voice 118",
        "nadia Kalian sadar ga sih telat jam berapa?", //emang nunggu brpa lama?
        ...
        //"show character  with fadeIn",
        "play voice 120",
        "nadia Dah dibilangin tadi disekolah ga usah bawa motor, malah kabur.",
        "show character roy gugup at left with fadeIn",
        "play voice 121",
        "roy Eee.. iya Nad maaf, Aku ga bawa motor lagi deh baik "+
        "ke sekolah maupun ke luar jalan jalan.",
        "arif Hayolo dimarahin Nadia. Wahaha...",
        "show character roy bicara at left with fadeIn",
        "play voice 122",
        "roy Lah kamu kan bareng aku juga.",
        "arif Kan cuman numpang. hahahah...",
        //"show character  with fadeIn",
        "play voice 123",
        "nadia Awas ya kalo bawa motor.", //kok ngancem
        "show character roy murung at left with fadeIn",
        "play voice 124",
        "roy Iya iya, Aku ga bawa.",
        "show character nadia bebasBicara at right with fadeIn",
        "play voice 125",
        "nadia Oke jangan bawa motor untuk 3 bulan ya.", // siapa anda?
        ...
        "show character roy bicara at left with fadeIn",
        "play voice 127",
        "roy Lah kamu malah ketawa.",
        "arif Seru soalnya liatin kamu dimarahin sama cewek. Hahaha...",
        //"show character  with fadeIn",
        "play voice 128",
        "roy Teman macam apa kamu",
        "show character nadia bebasNormal at right with fadeIn",
        "play voice 129",
        "nadia Udah lah, ntar coba aja ga usah bawa motor 3 bulan. nanti tau sendiri efeknya.",
        "show character roy senyum at left with fadeIn",
        "play voice 130",
        "roy Iya Nad.",
        "arif Yok lanjut kita ke mall. Ni waktu jalan terus loh.",
